...
public class File
{
    ...
    {
        System.out.println("Affichage les mots qui sont dans le dictionnaire");
    ...
    {
        System.out.printf("Affichage des mots qui commencent par %s et qui font %s lettres de long", s, i);
        for(String m : wordsList) {
    ...
    {
        System.out.println("Lettres trouvées : " + letters + "!");
